...
| # | 阶段 | 任务 | 前置 | 估期 | 状态 |
|---|---|---|---|---|---|
| S0-1 | 0 | Flyway 迁移版本化 | — | 3d | 📋 |
| S0-2 | 0 | Testcontainers 集成测试 | — | 3d | 📋 |
| S0-3 | 0 | Resilience4j 熔断降级 | — | 3d | 📋 |
| S0-4 | 0 | 评测跑通与基线记录 | S0-2 | 2d | 📋 |
| S1-1 | 1 | 指标取证工具 | S0-3 | 4d | 📋 |
| S1-2 | 1 | 变更取证工具 | S1-1 | 4d | 📋 |
| S1-3 | 1 | 日志取证工具 | S1-1 | 5d | 📋 |
| S1-4 | 1 | 拓扑取证工具（可延后） | S1-3 | 3d | 📋 |
| S1-5 | 1 | 证据模型与聚合器 | S1-1/2/3 | 4d | 📋 |
| S2-1 | 2 | 告警驱动自动诊断 | S1-5 | 4d | 📋 |
| S2-2 | 2 | 根因假设与置信度 | S2-1 | 4d | 📋 |
| S2-3 | 2 | 诊断报告与前端呈现 | S2-2 | 4d | 📋 |
| S3-1 | 3 | 执行器抽象与注册表 | S2-3 | 4d | 📋 |
| S3-2 | 3 | 首批执行器（重启/扩缩容） | S3-1 | 5d | 📋 |
| S3-3 | 3 | 审批执行与 Saga 补偿 | S3-2 | 4d | 📋 |
| S3-4 | 3 | 执行后验证与回滚 | S3-3 | 4d | 📋 |
| S3-5 | 3 | L4 前端页面 | S3-4 | 4d | 📋 |
| S4-1 | 4 | 评测判据升级 | S2-3 | 4d | 📋 |
| S4-2 | 4 | 置信度校准 | S4-1 | 3d | 📋 |
| S4-3 | 4 | CI 回归防劣化 | S4-1 | 3d | 📋 |
| S4-4 | 4 | 效果看板 | S4-1 | 3d | 📋 |
| S5-1 | 5 | 可观测性补全 | S3-5 | 3d | 📋 |
| S5-2 | 5 | 部署与运维文档 | S5-1 | 3d | 📋 |
| S5-3 | 5 | 安全加固 | S5-1 | 3d | 📋 |
| S5-4 | 5 | 性能与容量 | S5-1 | 3d | 📋 |
