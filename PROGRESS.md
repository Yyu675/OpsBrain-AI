...
| P0-2 | 引入 **springdoc-openapi** | 130 端点无机器可读契约，已因此出过 95 号前后端语义冲突事故 | 无 |
...
| # | 任务 | 状态 |
|---|---|---|
| F-1 | 富文本编辑器双套合一 | **等待决策**（见 99 号报告三个方案） |
| F-2 | 语法高亮语言包按需裁剪 | 随 F-1 一起做 |
| F-3 | knip 死代码清理 | knip 当前在本项目上崩溃（oxc-parser），需先修工具配置 |
